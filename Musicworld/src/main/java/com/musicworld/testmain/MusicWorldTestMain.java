...
public class MusicWorldTestMain {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		int select;
		long checkUser = 0;
		System.out.println("         'Welcome to MusicWorld' \n  Select your option: \n  1)Register/Signup \t  2)Login/Signin \t  3)Delete User \t 4)Update User ");
...
//			UserInfo str1=new UserInfo(userName1);
      ...
      System.out.println(checkUser);
		if(checkUser == 9344774428l) {
			System.out.println("         'Admin operations' \n  Select your option: \n  1)show songs \t  2)update songs \t 3)delete songs \t 4)add songs ");
			select = Integer.parseInt(sc.nextLine());
